...
let wp = {
  ...
  thumbnails: {
    small: (titles, lang) => (wp.query.pageimages(titles, 100, lang)),
    large: (titles, lang) => (wp.query.pageimages(titles, 600, lang))
  },
  query: {
    pageimages: (titles, size, lang = 'en') => {
